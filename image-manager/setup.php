...
class AYA_Image_Action
{
    ...
    public function self_config()
    {
        $config = array(
            ...
            'font_path' => (__DIR__) . '/assets/font/LXGWNeoXiHei.ttf',
            'offset_x' => 10,
            'offset_y' => 10,
            //水印参数
            'watermark_type' => 'text', //text image
            'watermark_position' => 'center-center',
            'watermark_image' => (__DIR__) . '/assets/image/default_watermark.png',
            ...
            'cover_bg_material_in' => array(
                (__DIR__) . '/assets/bg-image/circle-paint-1.png',
                (__DIR__) . '/assets/bg-image/circle-paint-2.png',
                (__DIR__) . '/assets/bg-image/circle-paint-3.png',
                (__DIR__) . '/assets/bg-image/circle-paint-4.png',
                (__DIR__) . '/assets/bg-image/color-splash-1.png',
                (__DIR__) . '/assets/bg-image/color-splash-2.png',
            ),
